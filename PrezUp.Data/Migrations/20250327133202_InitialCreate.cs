        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompareWithOthers = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    AllowPublicPresentations = table.Column<bool>(type: "tinyint(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClarityFeedback = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Fluency = table.Column<int>(type: "int", nullable: false),
                    FluencyFeedback = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Confidence = table.Column<int>(type: "int", nullable: false),
                    ConfidenceFeedback = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Engagement = table.Column<int>(type: "int", nullable: false),
                    EngagementFeedback = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SpeechStyle = table.Column<int>(type: "int", nullable: false),
                    SpeechStyleFeedback = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
